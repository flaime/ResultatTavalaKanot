...
//		        Console.Write(",");
	...
	public boolean FinnsBanaMedNamnet(String namn) {//TODO skriv den bättre så att den letar efter namn i namnet och inte efter att det måste vara identiskt... typ K4:a eller så
		for(Bana x : banorna){
